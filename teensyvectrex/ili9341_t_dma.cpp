...
static uint16_t fb0[LINES_PER_BLOCK*ILI9341_TFTWIDTH];
static uint16_t fb1[LINES_PER_BLOCK*ILI9341_TFTWIDTH];
static uint16_t fb2[LINES_PER_BLOCK*ILI9341_TFTWIDTH];
static uint16_t fb3[(ILI9341_TFTHEIGHT-3*LINES_PER_BLOCK)*ILI9341_TFTWIDTH];
...
void ILI9341_t_DMA::writeLine(int width, int height, int y, uint16_t *buf) {
